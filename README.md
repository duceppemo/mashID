...
<p align="center"><img src="docs/images/workflow_v3.svg" alt="mashID workflow" width="760"></p>
...
pip install https://github.com/duceppemo/mashID/archive/refs/tags/v0.2.6.tar.gz
...
> Duceppe, M.-O. (2026). mashID: species identification from genome assemblies and raw reads using Mash (v0.2.6). Zenodo. https://doi.org/10.5281/zenodo.22888109
