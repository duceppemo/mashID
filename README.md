...
pip install https://github.com/duceppemo/mashID/archive/refs/tags/v0.2.0.tar.gz
...
> Duceppe, M.-O. (2026). mashID: species identification from genome assemblies and raw reads using Mash (v0.2.0). https://github.com/duceppemo/mashID
