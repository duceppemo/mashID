...
| `-d, --database FILE.msh\|NAME` | Mash sketch database: a `.msh` file, or the name of a downloaded pre-built database (`mycobacteriaceae`, `mycobacteriaceae-2025`, `listeria`, `listeria-2025`, `progenomes3`, `refseq_bacteria`). Default: `mycobacteriaceae`. |
